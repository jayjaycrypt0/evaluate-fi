        ...
        <div className="w-full">
          <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
            ...
            <div className="flex justify-center">
              <a className="group inline-flex items-center bg-white/10 hover:bg-white/10 border border-white/10 p-1 ps-4 rounded-full shadow-md focus:outline-hidden focus:bg-white/10" href="/">
            ...
            <div className="max-w-3xl text-center mx-auto">
              <h1 className="block font-medium text-gray-200 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
                The first fully autonomous logic agentic platform.
              </h1>
            </div>
            {/* End Title */}
            ...
            <div className="max-w-3xl text-center mx-auto">
              ...
              AI-driven signals, technical analyisis, market intelligence, and deep social analytics for crypto and finance—all in one place.
              </p>
            </div>
